...
contract MarketPlaceTest is L2BaseTest {
    ...
    function testsetDiscountRate() public {
        ...
        MarketPlace(marketplaceProxyAddress).setDiscountRate(newDiscountRate);
        vm.stopPrank();
    }
    ...
    function testsetStakingIndex() public {
        ...
        MarketPlace(marketplaceProxyAddress).setStakingIndex(stakingIndex);

        assert(MarketPlace(marketplaceProxyAddress).getStakingIndex() == stakingIndex);
        vm.stopPrank();
    }
    ...
    */
    function testputGemForSaleShouldRevertIfGemIsLocked() public {
        ...
        MarketPlace(marketplaceProxyAddress).putGemForSale(0, price);
        vm.stopPrank();
    }
    ...
    */
    function testPutGemListForSaleShouldRevertIfTokenListEmpty() public {
        ...
        MarketPlace(marketplaceProxyAddress).putGemListForSale(tokenIds, prices);
        vm.stopPrank();
    }
    ...
    */
    ...
    function testRemoveGemForSaleShouldRevertIfPaused() public {
        ...
        vm.startPrank(owner);
        MarketPlace(marketplaceProxyAddress).pause();
        assert(MarketPlace(marketplaceProxyAddress).getPaused() == true);
        vm.stopPrank();
    ...
    */
    function testBuyGemShouldRevertIfTheGemIsNotForSale() public {
        vm.startPrank(user2);
        vm.expectRevert(MarketPlaceStorage.GemIsNotForSale.selector);
        MarketPlace(marketplaceProxyAddress).buyGem(0, false);
        vm.stopPrank();
    }
    ...
    */
    ...
    function testUnpause() public {
        testPause();
        vm.startPrank(owner);
        MarketPlace(marketplaceProxyAddress).unpause();
        assert( MarketPlace(marketplaceProxyAddress).getPaused() == false);
        vm.stopPrank();
    }
