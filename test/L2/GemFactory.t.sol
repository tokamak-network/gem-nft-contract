...
contract GemFactoryTest is L2BaseTest {
    ...
    function testCreateGEMInvalidQuadrantsAndSumForCommon() public {
        ...
        for (uint8 i = 0; i < 4; i++) {
            ...
            GemFactory(gemfactoryProxyAddress).createGEM(
                GemFactoryStorage.Rarity.COMMON, color, invalidQuadrantsCommon[i], tokenURI
            );
        }
        ...
        GemFactory(gemfactoryProxyAddress).createGEM(
            GemFactoryStorage.Rarity.COMMON, color, sumTooHighQuadrants, tokenURI
        );
    ...
    function testCreateGEMInvalidQuadrantsAndSumForRare() public {
        ...
        for (uint8 i = 0; i < 4; i++) {
            ...
            GemFactory(gemfactoryProxyAddress).createGEM(
                GemFactoryStorage.Rarity.RARE, color, invalidQuadrantsRare[i], tokenURI
            );
        }
        ...
        GemFactory(gemfactoryProxyAddress).createGEM(
            GemFactoryStorage.Rarity.RARE, color, sumTooHighQuadrants, tokenURI
        );
    ...
    function testCreateGEMInvalidQuadrantsForRareRarity() public {
        ...
        for (uint8 i = 0; i < 4; i++) {
            vm.expectRevert(abi.encodeWithSignature("NewGemInvalidQuadrant(uint8,uint8,uint8)", i, 2, 3));
            GemFactory(gemfactoryProxyAddress).createGEM(
                GemFactoryStorage.Rarity.RARE, color, invalidQuadrants[i], tokenURI
            );
        }
    ...
    function testCreateGEMInvalidQuadrantsAndSumForUnique() public {
        ...
        for (uint8 i = 0; i < 4; i++) {
            ...
            GemFactory(gemfactoryProxyAddress).createGEM(
                GemFactoryStorage.Rarity.UNIQUE, color, invalidQuadrantsUnique[i], tokenURI
            );
        }
        ...
        GemFactory(gemfactoryProxyAddress).createGEM(
            GemFactoryStorage.Rarity.UNIQUE, color, sumTooHighQuadrants, tokenURI
        );
    ...
    function testCreateGEMInvalidQuadrantsAndSumForEpic() public {
        ...
        for (uint8 i = 0; i < 4; i++) {
            ...
            GemFactory(gemfactoryProxyAddress).createGEM(
                GemFactoryStorage.Rarity.EPIC, color, invalidQuadrantsEpic[i], tokenURI
            );
        }
        ...
        GemFactory(gemfactoryProxyAddress).createGEM(
            GemFactoryStorage.Rarity.EPIC, color, sumTooHighQuadrants, tokenURI
        );
    ...
    function testCreateGEMInvalidQuadrantForLegendaryRarity() public {
        ...
        GemFactory(gemfactoryProxyAddress).createGEM(
            GemFactoryStorage.Rarity.LEGENDARY, color, invalidQuadrants, tokenURI
        );
    ...
    function testCreateGEMInvalidQuadrantsForLegendary() public {
        ...
        for (uint8 i = 0; i < 4; i++) {
            ...
            GemFactory(gemfactoryProxyAddress).createGEM(
                GemFactoryStorage.Rarity.LEGENDARY, color, invalidQuadrantsLegendary[i], tokenURI
            );
        }
    ...
    function testCreateGEMLegendary() public {
        ...
        uint256 newGemId =
            GemFactory(gemfactoryProxyAddress).createGEM(GemFactoryStorage.Rarity.LEGENDARY, color, quadrants, tokenURI);
    ...
    function testCreateGEMMythic() public {
        ...
        uint256 newGemId =
            GemFactory(gemfactoryProxyAddress).createGEM(GemFactoryStorage.Rarity.MYTHIC, color, quadrants, tokenURI);
    ...
    function testStartAndPickMiningTwice() public {
        ...
        GemFactory(gemfactoryProxyAddress).getRequestIds();
        GemFactoryStorage.RequestStatus memory randomRequest = GemFactory(gemfactoryProxyAddress).getRandomRequest(0);
        assert(GemFactory(gemfactoryProxyAddress).ownerOf(randomRequest.chosenTokenId) == user1);
